# <span style="color:hsl(30,80%,58%)">Observability Setup — Prometheus, Grafana, Tempo, Loki</span>
...
## <span style="color:hsl(168,80%,58%)">1. Start the stack</span>
...
## <span style="color:hsl(305,80%,58%)">2. Run the app</span>
...
## <span style="color:hsl(220,80%,58%)">4. Grafana</span>
...
## <span style="color:hsl(358,80%,58%)">5. Tracing & log correlation</span>
...
## <span style="color:hsl(135,80%,58%)">Tuning</span>
